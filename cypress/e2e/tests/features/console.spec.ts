...
describe('Feature: console', () => {
  ...
  it('Test 6: Console is disabled while AI is processing', () => {
    ...
    chat.getMessage(3).isCompleted();
    console.textarea().should('not.be.disabled');
