...
describe('Messages', () => {
  ...
  it('Show welcome message', () => {
    ...
    // The greeting renders as two separate elements (greetings.line1 / greetings.line2), so assert
    // each line individually rather than the concatenated string.
    welcomeMessage.containsText("I'm Liz, your personal AI assistant.");
    welcomeMessage.containsText('How can I help you?');
